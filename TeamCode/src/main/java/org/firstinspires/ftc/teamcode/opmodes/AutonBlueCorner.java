...
@Autonomous(name = "Auton Blue Corner", group = "4102")
public class AutonBlueCorner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        a = new AutonomousImplementation(false, false); //new Autonomous Implementation with isRed false and isParkingCenter false
